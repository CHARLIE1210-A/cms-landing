...
export function SignupForm({
  ...
  function renderForm() {
    return (
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        {/* Header */}
        <CardHeader className="space-y-2 p-0 text-center mb-6">
          <Link href="/" className="mx-auto flex items-center gap-3">
            <div className="rounded-2xl bg-brand-600 p-2.5 text-white shadow-lg">
        ...
        <FieldGroup className="space-y-0">
          ...
          <Field className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-0">
              ...
              <Input
                ...
                className={`bg-white border ${errors.confirmPassword ? "border-red-500 focus:ring-red-500/30" : "border-edge-default focus:border-brand-600"
                  } h-10 rounded-xl text-xs`}
              />
          ...
          <div className="relative">
            <Separator />
            <span className="bg-background absolute left-1/2 -translate-x-1/2 -translate-y-1/2 px-2 text-xs text-muted-foreground">
              OR
            </span>
          </div>

          {/* Google Button */}
          <Field className="grid grid-cols-3 gap-4 mb-4">
        ...
        {/* Redirect Footer */}
        <CardFooter className="justify-center pt-">
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="overflow-hidden rounded-[32px] border-white/20 bg-white/60 shadow-2xl backdrop-blur-xl">
        <div className="grid md:grid-cols-2">
          ...
          <div className="relative hidden md:block">
            <Image
              src="/images/auth/signup-cover.webp"
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-brand-950/20 via-transparent to-brand-950/40" />
          </div>
        </div>
